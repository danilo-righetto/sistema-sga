...
function wscep(conf)
{
    ...
    if(wsconf.auto == true){
        ...
        var btn_busca = '<div class="col-md-2" class="input-prepend"><label for="endereco">Endereço:</label>';
        btn_busca += '<input id="cep" name="cep" type="text" class="form-control" placeholder="CEP" required>';
