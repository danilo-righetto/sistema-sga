...
function wscep(conf)
{
    ...
    if(wsconf.auto == true){
        ...
        var btn_busca = '<div class="col-md-2" cep-label><label for="cep">CEP:</label>';
        btn_busca += '<input type="text" class="form-control" id="cep" name="cep"  placeholder="CEP..." required>';
