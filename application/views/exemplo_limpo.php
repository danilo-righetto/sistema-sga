                    ...
                    <div class="grid_12">
                        ...
                        <div class="grid_4">
                            <div class="input-prepend">
                                ...
                                <input id="nome" name="nome" type="text" placeholder="Informe o Nome" />
                            </div>
                            <div class="input-prepend">
                                <span class="add-on">RG</span>
                                <input id="rg" name="rg" type="text" placeholder="Informe o RG" />
                            </div>
                            ...
                            <div class="input-prepend">
                                ...
                                <input id="cpf" name="cpf" type="text" placeholder="Informe o CPF" />
                            </div>

                            <div class="input-prepend">
                                <span class="add-on">Sexo</span>
                                <input id="sexo" name="sexo" type="text" placeholder="Informe o Sexo" />
                            </div>
                            <div class="input-prepend">
                                <span class="add-on">Data Nasc:</span>
                                <input id=dataNascimento name="dataNascimento" type="date" placeholder="Informe a Data de Nascimento" />
                            </div>                            
